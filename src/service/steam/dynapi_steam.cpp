...
bool DynApiSteam::Init() {
    ClearFuncsToNull();
    c_SteamAPI_InitFlat = (C_STEAMAPI_INITFLAT ) (intptr_t) LoadFunc("c_SteamAPI_InitFlat");
    if (!c_SteamAPI_InitFlat) {
        return false;
    }
    c_SteamAPI_Shutdown = (C_STEAMAPI_SHUTDOWN) (intptr_t) LoadFunc("c_SteamAPI_Shutdown");
    if (!c_SteamAPI_Shutdown) {
        return false;
    }
    c_SteamAPI_RunCallbacks = (C_STEAMAPI_RUNCALLBACKS) (intptr_t) LoadFunc("c_SteamAPI_RunCallbacks");
    if (!c_SteamAPI_RunCallbacks) {
        return false;
    }
    c_SteamInternal_CreateInterface = (C_STEAMINTERNAL_CREATEINTERFACE) (intptr_t) LoadFunc("c_SteamInternal_CreateInterface");
    if (!c_SteamInternal_CreateInterface) {
        return false;
    }
    c_SteamAPI_GetHSteamUser = (C_STEAMAPI_GETHSTEAMUSER) (intptr_t) LoadFunc("c_SteamAPI_GetHSteamUser");
    if (!c_SteamAPI_GetHSteamUser) {
        return false;
    }
    c_SteamAPI_GetHSteamPipe = (C_STEAMAPI_GETHSTEAMPIPE) (intptr_t) LoadFunc("c_SteamAPI_GetHSteamPipe");
    if (!c_SteamAPI_GetHSteamPipe) {
        return false;
    }
    c_SteamAPI_ISteamClient_GetISteamUserStats = (C_STEAMAPI_ISTEAMCLIENT_GETISTEAMUSERSTATS) (intptr_t) LoadFunc("c_SteamAPI_ISteamClient_GetISteamUserStats");
    if (!c_SteamAPI_ISteamClient_GetISteamUserStats) {
        return false;
    }
    c_SteamAPI_ISteamUserStats_RequestCurrentStats = (C_STEAMAPI_ISTEAMUSERSTATS_REQUESTCURRENTSTATS) (intptr_t) LoadFunc("c_SteamAPI_ISteamUserStats_RequestCurrentStats");
    if (!c_SteamAPI_ISteamUserStats_RequestCurrentStats) {
        return false;
    }
    c_SteamAPI_ISteamUserStats_StoreStats = (C_STEAMAPI_ISTEAMUSERSTATS_STORESTATS) (intptr_t) LoadFunc("c_SteamAPI_ISteamUserStats_StoreStats");
    if (!c_SteamAPI_ISteamUserStats_StoreStats) {
        return false;
    }
    c_SteamAPI_ISteamUserStats_SetAchievement = (C_STEAMAPI_ISTEAMUSERSTATS_SETACHIEVEMENT) (intptr_t) LoadFunc("c_SteamAPI_ISteamUserStats_SetAchievement");
    if (!c_SteamAPI_ISteamUserStats_SetAchievement) {
        return false;
    }
    c_SteamAPI_ISteamUserStats_GetAchievement = (C_STEAMAPI_ISTEAMUSERSTATS_GETACHIEVEMENT) (intptr_t) LoadFunc("c_SteamAPI_ISteamUserStats_GetAchievement");
    if (!c_SteamAPI_ISteamUserStats_GetAchievement) {
        return false;
    }
    c_SteamAPI_ISteamUserStats_ClearAchievement = (C_STEAMAPI_ISTEAMUSERSTATS_CLEARACHIEVEMENT) (intptr_t) LoadFunc("c_SteamAPI_ISteamUserStats_ClearAchievement");
    if (!c_SteamAPI_ISteamUserStats_ClearAchievement) {
        return false;
    }
    c_SteamAPI_ISteamUserStats_GetNumAchievements = (C_STEAMAPI_ISTEAMUSERSTATS_GETNUMACHIEVEMENTS) (intptr_t) LoadFunc("c_SteamAPI_ISteamUserStats_GetNumAchievements");
    if (!c_SteamAPI_ISteamUserStats_GetNumAchievements) {
        return false;
    }
    c_SteamAPI_ISteamClient_GetISteamScreenshots = (C_STEAMAPI_ISTEAMCLIENT_GETISTEAMSCREENSHOTS) (intptr_t) LoadFunc("c_SteamAPI_ISteamClient_GetISteamScreenshots");
    if (!c_SteamAPI_ISteamClient_GetISteamScreenshots) {
        return false;
    }
    c_SteamAPI_ISteamScreenshots_HookScreenshots = (C_STEAMAPI_ISTEAMSCREENSHOTS_HOOKSCREENSHOTS) (intptr_t) LoadFunc("c_SteamAPI_ISteamScreenshots_HookScreenshots");
    if (!c_SteamAPI_ISteamScreenshots_HookScreenshots) {
        return false;
    }
    c_SteamAPI_ISteamScreenshots_WriteScreenshot = (C_STEAMAPI_ISTEAMSCREENSHOTS_WRITESCREENSHOT) (intptr_t) LoadFunc("c_SteamAPI_ISteamScreenshots_WriteScreenshot");
    if (!c_SteamAPI_ISteamScreenshots_WriteScreenshot) {
        return false;
    }
    c_SteamAPI_ManualDispatch_Init = (C_STEAMAPI_MANUALDISPATCH_INIT) (intptr_t) LoadFunc("c_SteamAPI_ManualDispatch_Init");
    if (!c_SteamAPI_ManualDispatch_Init) {
        return false;
    }
    c_SteamAPI_ManualDispatch_RunFrame = (C_STEAMAPI_MANUALDISPATCH_RUNFRAME) (intptr_t) LoadFunc("c_SteamAPI_ManualDispatch_RunFrame");
    if (!c_SteamAPI_ManualDispatch_RunFrame) {
        return false;
    }
    c_SteamAPI_ManualDispatch_GetNextCallback = (C_STEAMAPI_MANUALDISPATCH_GETNEXTCALLBACK) (intptr_t) LoadFunc("c_SteamAPI_ManualDispatch_GetNextCallback");
    if (!c_SteamAPI_ManualDispatch_GetNextCallback) {
        return false;
    }
    c_SteamAPI_ManualDispatch_FreeLastCallback = (C_STEAMAPI_MANUALDISPATCH_FREELASTCALLBACK) (intptr_t) LoadFunc("c_SteamAPI_ManualDispatch_FreeLastCallback");
    if (!c_SteamAPI_ManualDispatch_FreeLastCallback) {
        return false;
    }
    c_SteamAPI_ManualDispatch_GetAPICallResult = (C_STEAMAPI_MANUALDISPATCH_GETAPICALLRESULT) (intptr_t) LoadFunc("c_SteamAPI_ManualDispatch_GetAPICallResult");
